...
urlpatterns = [
    ...
    path("club/disciplines/ordre/", club_views.disciplines_reorder, name="disciplines_reorder"),
    path("club/disciplines/<int:pk>/deplacer/", club_views.discipline_move,
         name="discipline_move"),
    path("club/criteres/", club_views.criteria, name="criteria"),
    path("club/criteres/ordre/", club_views.criteria_reorder, name="criteria_reorder"),
    path("club/criteres/<int:pk>/deplacer/", club_views.criterion_move, name="criterion_move"),
